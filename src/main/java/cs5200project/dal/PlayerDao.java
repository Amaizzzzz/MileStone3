...
public class PlayerDao {
    ...
    public static Player create(Connection cxn, String username, String email, String serverRegion) throws SQLException {
        String sql = "INSERT INTO Player(username, email, serverRegion) VALUES (?, ?, ?)";
        PreparedStatement ps = cxn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
    ...
    public static Player updateUsername(Connection cxn, Player player, String newUsername) throws SQLException {
    ...
    public static List<Player> getPlayersByPartialName(Connection cxn, String partialName) throws SQLException {
