...
public class StatTypeDao {
     ...
     */
    public static StatType create(Connection cxn, String name, String description)
            throws SQLException {
     ...
     * @param cxn The database connection
     * @param statType The StatType object to update (must have a valid statTypeID)
     * @param newDescription The new description value
     * @return The updated StatType object
     */
    public static StatType updateDescription(Connection cxn, StatType statType, String newDescription)
            throws SQLException {
     ...
     * @param cxn The database connection
     * @param statType The StatType object to delete (must have a valid statTypeID)
     */
    ...
    /**
     * Retrieves a list of StatType records whose name contains a given substring.
     * @param cxn The database connection
     ...
     */
    public static List<StatType> getStatTypeByName(Connection cxn, String partialName)
            throws SQLException {
